...
async def parse_cmd():
    ...
    parser.add_argument('--headless', type=str2bool,
                        help='whether to show the browser window', default=config.HEADLESS)

    parser.add_argument('--bv', type=str,
                        help='BV id for Bilibili Video', default=config.BILI_SPECIFIED_ID_LIST)
    parser.add_argument('--xhs_url', type=str,
                        help='URL for XHS note page', default=config.XHS_SPECIFIED_NOTE_URL_LIST)
    parser.add_argument('--wb_url', type=str,
                        help='URL for Weibo post page', default=config.WEIBO_SPECIFIED_ID_LIST)
    parser.add_argument('--max_count', type=int,
                        help='Maximum of crawled notes or comments', default=config.CRAWLER_MAX_COMMENTS_COUNT_SINGLENOTES)
    ...
    config.BILI_SPECIFIED_ID_LIST = [args.bv]
    config.XHS_SPECIFIED_NOTE_URL_LIST = [args.xhs_url]
    config.WEIBO_SPECIFIED_ID_LIST = [args.wb_url]
    config.CRAWLER_MAX_COMMENTS_COUNT_SINGLENOTES = args.max_count
